package com.levent.core.util.id;

import com.levent.core.async.AsyncUtil;
import com.levent.core.util.CompressUtil;
import com.levent.core.util.id.snowflake.PaiSnowflakeIdGenerator;
import com.levent.core.util.id.snowflake.SnowflakeProducer;

import static com.levent.core.util.CompressUtil.int2str;
